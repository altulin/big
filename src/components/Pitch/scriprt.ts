  ...
  const pitch: TPitch[] = [
    {
      ...
      list: [
        ...
        {
          label:
            "Победитель среди молодых специалистов получит 5 млн рублей на реализацию проекта и саппорт в продвижении на NUUM. Победитель среди опытных — 20 млн рублей.",
        },
        {
