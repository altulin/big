  ...
  const pitch: TPitch[] = [
    {
      ...
      // icon: IconNuum,
      icon: IconNuumOnce,
      text: "Запусти свой проект на платформе Nuum. С тебя — идея, с нас — поддержка и аудитория.",
      deadline: [
        "Дата проведения зум-брифинга - 9 сентября",
      ...
      list: [
        {
          ...
          href: "#",
          label_2:
            "и загрузи презентацию проекта в личном кабинете. Выбери категорию Бренд-питчи, а затем Питч от NUUM",
        },
        {
          label:
            "Все работы отсмотрит жюри фестиваля вместе с представителями NUUM. Пять лучших работ молодых специалистов и пять лучших работ опытных продакшнов будут приглашены на публичный Content Battle.",
          // link: "https://nuum.ru/",
          // href: "https://nuum.ru/",
        },
        {
          label:
            "Работа победителя среди молодых специалистов получит 5 млн рублей на реализацию проекта и поддержку в продвижении на платформе Nuum, работа победителя среди опытных продакшнов — 20 млн рублей.",
        },
        // {
        //   label:
